            ...
            <section className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center justify-center max-w-[1200px] m-auto px-6 py-12 md:py-20 min-h-[calc(100vh-100px)] relative z-10">
                ...
                <div className="flex flex-col items-start gap-4 flex-1 max-w-xl animate-fade-in">
                    ...
                    <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-white leading-tight">
                        Get Started with <span className="bg-gradient-to-r from-[#A78BFA] to-[#6D28D9] bg-clip-text text-transparent">Evolv</span>
                    </h1>
                    ...
                    <p className="text-sm text-zinc-400 mt-6">
                        ...
                        <Link href="/auth/login" className="text-[#A78BFA] hover:text-[#6D28D9] font-semibold transition-colors duration-200 underline underline-offset-4 decoration-2">
                            Sign in
                        </Link>
                    </p>
                </div>
                ...
                <div className="w-full sm:max-w-md p-8 rounded-3xl border border-zinc-800/80 bg-zinc-950/40 backdrop-blur-md shadow-2xl shadow-[#6D28D9]/5 relative overflow-hidden flex flex-col gap-6">
                    <div>
                        ...
                        <p className="text-sm text-zinc-400 mt-1">Fill in the details to get started</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        ...
                        <button type='submit' className="w-full h-11 mt-2 bg-[#6D28D9] hover:bg-[#5B21B6] text-white font-semibold rounded-xl shadow-lg shadow-[#6D28D9]/20 hover:shadow-[#6D28D9]/40 active:scale-[0.98] transition-all duration-200 cursor-pointer flex items-center justify-center gap-2">
                            Create Account
                        </button>
                    </form>
                </div>
